...
public class StatsGUI implements InventoryProvider {
    ...
    public void init(Player player, InventoryContents contents) {
        try {
            ...
            contents.set(2, 3, ClickableItem.empty(Util.createItem(XMaterial.DIAMOND_CHESTPLATE.parseMaterial(), "§3Defense Skill", "§8§m------------------------", "§7By leveling up this skill, you", "§7gain permanent §3DEFENSE§7! Can be increased", "§7by finding and utilizing §3§nDefense Artifacts§7.", "", "§6§l➢ §e" + this.player.getName() + "§7's current Defense Level: §3" + Util.IntegerToRomanNumeral(sql.getValue(TableType.DATA_DEFENSE, "LEVEL", this.player.getUniqueId().toString())), "   §e§lCURRENT PROGRESS§7: §3" + String.format("%,d", sql.getValue(TableType.DATA_DEFENSE, "CURRENT_XP", this.player.getUniqueId().toString())) + "§8/§3" + String.format("%,d", sql.getValue(TableType.DATA_DEFENSE, "XP_TO_NEXT_LEVEL", this.player.getUniqueId().toString())), "", "§7§o(Refreshes every 5 minutes)", "§8§m------------------------")));
